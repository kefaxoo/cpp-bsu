// вывод не совсем правый нижний треугольник, но выводится именно он!
...
int main() {
    ...
    int matrix[sizeOfColumn][sizeOfLine] = {{45, 4, 82}, {44, 5, 44}, {70, 53, 56}}, count = 0;
    
    for (int i = 0; i < sizeOfColumn; i++) {
        for (int j = 0; j < sizeOfLine - i - 1; j++)
            cout << " ";
        for (int j = sizeOfLine - i - 1; j < sizeOfLine; j++) {
            cout << matrix[i][j] << " ";
